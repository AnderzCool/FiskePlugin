...
public class Rewards {
    ...
    public Rewards(JavaPlugin instance, String folderName, String fileName) {
    ...
    public void saveConfig() {
        ...
        try {
            ...
            if (this.plugin != null) {
                this.plugin.getLogger().log(Level.SEVERE, "Could not save rewards config to " + this.configFile, ex);
            } else {
                ex.printStackTrace();
            }
        }
